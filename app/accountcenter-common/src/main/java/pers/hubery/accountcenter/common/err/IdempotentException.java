 ...
 *
 * @author Hubery
 * @version IdempotentException.java v1.0 2022-04-18 00:28
 */
public class IdempotentException extends RuntimeException {
     ...
     * @since 1.4
     */
    public IdempotentException(final Throwable cause) {
        super(cause);
    }

    /**
     * Constructs a new runtime exception with the specified detail message, cause, suppression enabled or disabled, and writable stack
     ...
     * @since 1.7
     */
    public IdempotentException(final String message, final Throwable cause, final boolean enableSuppression,
